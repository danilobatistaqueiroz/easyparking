...
class TagsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'sqlite_autoindex_tags_2' => ['type' => 'unique', 'columns' => ['title'], 'length' => []],
            'sqlite_autoindex_tags_1' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-04-17 23:09:30',
                'modified' => '2018-04-17 23:09:30'
            ],
        ];
        parent::init();
    }
